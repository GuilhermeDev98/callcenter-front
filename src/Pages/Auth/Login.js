  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (status === 200 && data.data.token)
        ...
        console.log(data.data.user.role.permissions)
        localStorage.setItem("call@userPermissions", data.data.user.role.permissions.map(e => e.name))
        localStorage.setItem("call@webphone", "https://voice-app.zenvia.com/w3/?key=7e4156344b297eaeb7483e946375fde6&tipo=hidden&ver=2")
