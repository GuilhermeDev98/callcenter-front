        ...
        <>
            <List>
                ...
                <Can permission='attendance.show'>
                    <Link to="" style={{ textDecoration: 'none' }} onClick={() => HandleOpenDialogSearchClient()}>
                        <ListItem style={{ background: '#3C96EF', borderRadius: '10px', marginTop: '10px', }}>
                            <ListItemIcon style={{ background: '' }}>
                ...
                <Can permission='workplace.show'>
                    <Link to="/dashboard/workplace" style={{ textDecoration: 'none' }}>
                        <ListItem style={{ background: '#3C96EF', borderRadius: '10px', marginTop: '10px', }}>
                            <ListItemIcon style={{ background: '' }}>
                        ...
                        <Table size="small" aria-label="a dense table">
                            ...
                            <TableBody>
                                {Clients.map((row) => (
                                    ...
                                    >
                                        <Link to={`/dashboard/attendance/${row.registration}`} onClick={() => SetDialogSearchClient(false)} style={{ textDecoration: 'none' }}>
